      ...
      <header className="flex items-center justify-between px-6 py-4 md:px-12 border-b border-[#1F2937]/50 sticky top-0 bg-[#0B0F14]/90 backdrop-blur z-50">
        ...
        <div className="flex items-center gap-4">
          ...
          <Link
            ...
            className="text-sm font-semibold bg-neon text-[#0B0F14] px-4 py-2 rounded-xl hover:bg-neon-hover transition"
          >
            Ro'yxatdan o'tish
          </Link>
        </div>
      ...
      <main className="flex-1 flex flex-col items-center max-w-7xl mx-auto w-full px-6 md:px-12 pt-20 pb-24">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          <div className="max-w-xl">
            ...
            <p className="text-gray-400 text-lg mb-8 leading-relaxed">
              Interaktiv testlar, real vaqtda reytinglar va amaliy
              qiyinchiliklar bilan dasturlash ko'nikmalaringizni mustahkamlang.
            </p>
            <div className="flex flex-wrap gap-4">
              <Link
                href="/login?tab=register"
                className="flex items-center justify-center gap-2 text-sm font-bold bg-neon text-[#0B0F14] px-6 py-3.5 rounded-xl hover:bg-neon-hover transition shadow-[0_0_20px_rgba(16,185,129,0.3)]"
              >
                Boshlash
              </Link>
              <Link
                href="#features"
                className="flex items-center justify-center gap-2 text-sm font-bold bg-[#1F2937] text-white px-6 py-3.5 rounded-xl hover:bg-[#374151] transition"
              >
                Ko'proq ma'lumot
              </Link>
            </div>
            ...
            <div className="mt-12">
              ...
              <div className="flex flex-wrap gap-3">
                {[
                  ...
                  <span
                    key={tech.name}
                    className="flex items-center gap-2 px-3 py-1.5 rounded-lg bg-[#161B22] border border-[#30363D] text-xs font-medium text-gray-300"
                  >
                    <span
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            <div className="bg-[#161B22] border border-[#30363D] p-6 rounded-2xl hover:border-gray-500 transition">
              ...
              <p className="text-sm text-gray-400 leading-relaxed">
                HTML, CSS, JavaScript, TypeScript, React va boshqa
                texnologiyalar bo'yicha testlar.
              </p>
            </div>
            <div className="bg-[#161B22] border border-[#30363D] p-6 rounded-2xl hover:border-gray-500 transition">
              ...
              <p className="text-sm text-gray-400 leading-relaxed">
                Qiyin, o'rtacha, oson darajadagi testlarni tanlang va o'zingizni
                sinab ko'ring.
              </p>
            </div>
            <div className="bg-[#161B22] border border-[#30363D] p-6 rounded-2xl hover:border-gray-500 transition">
              ...
              <p className="text-sm text-gray-400 leading-relaxed">
                Test tayyorlash, ishlash va ballar olishda ajoyib imkoniyat.
              </p>
            </div>
            <div className="bg-[#161B22] border border-[#30363D] p-6 rounded-2xl hover:border-gray-500 transition">
              ...
              <p className="text-sm text-gray-400 leading-relaxed">
                O'zlashtirgan bilimlaringizni kuzatib, natijalaringizga qarab
                o'sish.
              </p>
            </div>
            <div className="bg-[#161B22] border border-[#30363D] p-6 rounded-2xl hover:border-gray-500 transition">
              ...
              <p className="text-sm text-gray-400 leading-relaxed">
                Boshqa foydalanuvchilar bilan bellashing va eng yuqori o'rinni
                egallang.
              </p>
            </div>
            <div className="bg-[#161B22] border border-[#30363D] p-6 rounded-2xl hover:border-gray-500 transition">
              ...
              <p className="text-sm text-gray-400 leading-relaxed">
                Ko'zni toliqtirmaydigan, zamonaviy va chiroyli interfeys.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="mt-32 mb-10 w-full max-w-3xl mx-auto bg-[#161B22] border border-[#30363D] rounded-3xl p-10 text-center flex flex-col items-center">
          ...
          <p className="text-gray-400 text-sm mb-8">
            Testni o'ting va dasturlash ko'nikmalaringizni sinab ko'ring.
          </p>
          <div className="flex flex-wrap gap-4 justify-center">
            <Link
              href="/login?tab=register"
              className="flex items-center justify-center gap-2 text-sm font-bold bg-neon text-[#0B0F14] px-6 py-3 rounded-xl hover:bg-neon-hover transition"
            >
              Boshlash
            </Link>
            <Link
              href="#features"
              className="flex items-center justify-center gap-2 text-sm font-bold bg-[#1F2937] text-white px-6 py-3 rounded-xl hover:bg-[#374151] transition"
            >
              Batafsil tanishish
            </Link>
          </div>
