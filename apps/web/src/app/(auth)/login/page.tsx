...
export default function LoginPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Store the tokens first so getProfile can use it
              ...
              <>
                ...
                <CardFooter className="flex flex-col gap-4">
                  <motion.div whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.98 }} className="w-full">
                    <Button type="submit" className="w-full bg-neon text-[#0B0F14] hover:bg-neon-hover font-bold h-11" disabled={loading}>
                  ...
                  <div className="relative w-full text-center">
                    ...
                    <div className="relative flex justify-center text-xs uppercase">
                      <span className="bg-[#161B22] px-2 text-gray-400">Yoki</span>
                    </div>
                  </div>
                  ...
                  <div className="grid grid-cols-2 gap-4 w-full">
                    <Button 
                      type="button"
                      variant="outline"
                      className="w-full border-[#30363D] bg-transparent hover:bg-[#1F2937] text-white"
